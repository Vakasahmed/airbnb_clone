    ...
    return (
        <>
            <Box className="middleResponsive" maxWidth="false">
                    ...
                    <Container className="imageTextContainer" maxWidth="false" sx={{ width: "auto", marginLeft: 10, marginRight:10 }}>
                        <Stack className="app2">
                            <Stack justifyContent="space-between" direction="row"  >
                                <Typography fontSize={35} fontWeight="600" >New this Week</Typography>
                    ...
                    <Box className="imageContainer" maxWidth="false" style={{ height: 460 }}>
                        <ImageList ref={scrl2} onScroll={scrollCheck2} style={{ overflow: "hidden", paddingLeft: 60 }} cols={3}>
                            {itemData.map((item) => (
